...
func (obj *VirtualDnsRecord) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= virtual_DNS_record_annotations
}
...
func (obj *VirtualDnsRecord) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_DNS_record_tag_refs == 0) {
...
func (obj *VirtualDnsRecord) AddTag(
        ...
        if obj.modified & virtual_DNS_record_tag_refs == 0 {
...
func (obj *VirtualDnsRecord) ClearTag() {
        if (obj.valid & virtual_DNS_record_tag_refs != 0) &&
           (obj.modified & virtual_DNS_record_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *VirtualDnsRecord) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & virtual_DNS_record_annotations != 0 {
                var value json.RawMessage
...
func (obj *VirtualDnsRecord) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= virtual_DNS_record_annotations
                        }
                        break
                case "display_name":
