...
func (obj *ServiceApplianceSet) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & service_appliance_set_tag_refs == 0) {
...
func (obj *ServiceApplianceSet) AddTag(
        ...
        if obj.modified & service_appliance_set_tag_refs == 0 {
...
func (obj *ServiceApplianceSet) ClearTag() {
        if (obj.valid & service_appliance_set_tag_refs != 0) &&
           (obj.modified & service_appliance_set_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
