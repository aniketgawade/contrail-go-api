...
func (obj *LoadbalancerHealthmonitor) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_healthmonitor_tag_refs == 0) {
...
func (obj *LoadbalancerHealthmonitor) AddTag(
        ...
        if obj.modified & loadbalancer_healthmonitor_tag_refs == 0 {
...
func (obj *LoadbalancerHealthmonitor) ClearTag() {
        if (obj.valid & loadbalancer_healthmonitor_tag_refs != 0) &&
           (obj.modified & loadbalancer_healthmonitor_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
