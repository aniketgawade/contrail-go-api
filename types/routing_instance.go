...
func (obj *RoutingInstance) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= routing_instance_annotations
}
...
func (obj *RoutingInstance) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & routing_instance_tag_refs == 0) {
...
func (obj *RoutingInstance) AddTag(
        ...
        if obj.modified & routing_instance_tag_refs == 0 {
...
func (obj *RoutingInstance) ClearTag() {
        if (obj.valid & routing_instance_tag_refs != 0) &&
           (obj.modified & routing_instance_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *RoutingInstance) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & routing_instance_annotations != 0 {
                var value json.RawMessage
...
func (obj *RoutingInstance) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= routing_instance_annotations
                        }
                        break
                case "display_name":
