...
func (obj *LogicalRouter) SetVxlanNetworkIdentifier(value string) {
        ...
        obj.modified |= logical_router_vxlan_network_identifier
}
...
func (obj *LogicalRouter) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= logical_router_annotations
}
...
func (obj *LogicalRouter) readPhysicalRouterRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & logical_router_physical_router_refs == 0) {
...
func (obj *LogicalRouter) AddPhysicalRouter(
        ...
        if obj.modified & logical_router_physical_router_refs == 0 {
...
func (obj *LogicalRouter) ClearPhysicalRouter() {
        if (obj.valid & logical_router_physical_router_refs != 0) &&
           (obj.modified & logical_router_physical_router_refs == 0) {
                obj.storeReferenceBase("physical-router", obj.physical_router_refs)
        }
...
func (obj *LogicalRouter) readBgpvpnRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & logical_router_bgpvpn_refs == 0) {
...
func (obj *LogicalRouter) AddBgpvpn(
        ...
        if obj.modified & logical_router_bgpvpn_refs == 0 {
...
func (obj *LogicalRouter) ClearBgpvpn() {
        if (obj.valid & logical_router_bgpvpn_refs != 0) &&
           (obj.modified & logical_router_bgpvpn_refs == 0) {
                obj.storeReferenceBase("bgpvpn", obj.bgpvpn_refs)
        }
...
func (obj *LogicalRouter) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & logical_router_tag_refs == 0) {
...
func (obj *LogicalRouter) AddTag(
        ...
        if obj.modified & logical_router_tag_refs == 0 {
...
func (obj *LogicalRouter) ClearTag() {
        if (obj.valid & logical_router_tag_refs != 0) &&
           (obj.modified & logical_router_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *LogicalRouter) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & logical_router_vxlan_network_identifier != 0 {
                var value json.RawMessage
        ...
        if obj.modified & logical_router_annotations != 0 {
                var value json.RawMessage
...
func (obj *LogicalRouter) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "vxlan_network_identifier":
                        ...
                        if err == nil {
                                obj.valid |= logical_router_vxlan_network_identifier
                        }
                        break
                case "id_perms":
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= logical_router_annotations
                        }
                        break
                case "display_name":
