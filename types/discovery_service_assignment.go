...
func (obj *DiscoveryServiceAssignment) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= discovery_service_assignment_annotations
}
...
func (obj *DiscoveryServiceAssignment) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & discovery_service_assignment_tag_refs == 0) {
...
func (obj *DiscoveryServiceAssignment) AddTag(
        ...
        if obj.modified & discovery_service_assignment_tag_refs == 0 {
...
func (obj *DiscoveryServiceAssignment) ClearTag() {
        if (obj.valid & discovery_service_assignment_tag_refs != 0) &&
           (obj.modified & discovery_service_assignment_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *DiscoveryServiceAssignment) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & discovery_service_assignment_annotations != 0 {
                var value json.RawMessage
...
func (obj *DiscoveryServiceAssignment) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= discovery_service_assignment_annotations
                        }
                        break
                case "display_name":
