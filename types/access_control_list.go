...
func (obj *AccessControlList) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & access_control_list_tag_refs == 0) {
...
func (obj *AccessControlList) AddTag(
        ...
        if obj.modified & access_control_list_tag_refs == 0 {
...
func (obj *AccessControlList) ClearTag() {
        if (obj.valid & access_control_list_tag_refs != 0) &&
           (obj.modified & access_control_list_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
