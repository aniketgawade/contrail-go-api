...
func (obj *AliasIpPool) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= alias_ip_pool_annotations
}
...
func (obj *AliasIpPool) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & alias_ip_pool_tag_refs == 0) {
...
func (obj *AliasIpPool) AddTag(
        ...
        if obj.modified & alias_ip_pool_tag_refs == 0 {
...
func (obj *AliasIpPool) ClearTag() {
        if (obj.valid & alias_ip_pool_tag_refs != 0) &&
           (obj.modified & alias_ip_pool_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *AliasIpPool) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & alias_ip_pool_annotations != 0 {
                var value json.RawMessage
...
func (obj *AliasIpPool) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= alias_ip_pool_annotations
                        }
                        break
                case "display_name":
