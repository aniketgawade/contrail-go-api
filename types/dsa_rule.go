...
func (obj *DsaRule) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= dsa_rule_annotations
}
...
func (obj *DsaRule) AddTag(
        ...
        if obj.modified & dsa_rule_tag_refs == 0 {
...
func (obj *DsaRule) ClearTag() {
        if (obj.valid & dsa_rule_tag_refs != 0) &&
           (obj.modified & dsa_rule_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *DsaRule) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & dsa_rule_annotations != 0 {
                var value json.RawMessage
...
func (obj *DsaRule) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= dsa_rule_annotations
                        }
                        break
                case "display_name":
