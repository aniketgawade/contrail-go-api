...
func (obj *LoadbalancerListener) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= loadbalancer_listener_annotations
}
...
func (obj *LoadbalancerListener) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_listener_tag_refs == 0) {
...
func (obj *LoadbalancerListener) AddTag(
        ...
        if obj.modified & loadbalancer_listener_tag_refs == 0 {
...
func (obj *LoadbalancerListener) ClearTag() {
        if (obj.valid & loadbalancer_listener_tag_refs != 0) &&
           (obj.modified & loadbalancer_listener_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *LoadbalancerListener) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & loadbalancer_listener_annotations != 0 {
                var value json.RawMessage
...
func (obj *LoadbalancerListener) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= loadbalancer_listener_annotations
                        }
                        break
                case "display_name":
