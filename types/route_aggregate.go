...
func (obj *RouteAggregate) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= route_aggregate_annotations
}
...
func (obj *RouteAggregate) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & route_aggregate_tag_refs == 0) {
...
func (obj *RouteAggregate) AddTag(
        ...
        if obj.modified & route_aggregate_tag_refs == 0 {
...
func (obj *RouteAggregate) ClearTag() {
        if (obj.valid & route_aggregate_tag_refs != 0) &&
           (obj.modified & route_aggregate_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *RouteAggregate) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & route_aggregate_annotations != 0 {
                var value json.RawMessage
...
func (obj *RouteAggregate) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= route_aggregate_annotations
                        }
                        break
                case "display_name":
