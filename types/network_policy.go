...
func (obj *NetworkPolicy) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & network_policy_tag_refs == 0) {
...
func (obj *NetworkPolicy) AddTag(
        ...
        if obj.modified & network_policy_tag_refs == 0 {
...
func (obj *NetworkPolicy) ClearTag() {
        if (obj.valid & network_policy_tag_refs != 0) &&
           (obj.modified & network_policy_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
