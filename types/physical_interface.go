...
func (obj *PhysicalInterface) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= physical_interface_annotations
}
...
func (obj *PhysicalInterface) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & physical_interface_tag_refs == 0) {
...
func (obj *PhysicalInterface) AddTag(
        ...
        if obj.modified & physical_interface_tag_refs == 0 {
...
func (obj *PhysicalInterface) ClearTag() {
        if (obj.valid & physical_interface_tag_refs != 0) &&
           (obj.modified & physical_interface_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *PhysicalInterface) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & physical_interface_annotations != 0 {
                var value json.RawMessage
...
func (obj *PhysicalInterface) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= physical_interface_annotations
                        }
                        break
                case "display_name":
