...
func (obj *ServiceInstance) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= service_instance_annotations
}
...
func (obj *ServiceInstance) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & service_instance_tag_refs == 0) {
...
func (obj *ServiceInstance) AddTag(
        ...
        if obj.modified & service_instance_tag_refs == 0 {
...
func (obj *ServiceInstance) ClearTag() {
        if (obj.valid & service_instance_tag_refs != 0) &&
           (obj.modified & service_instance_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ServiceInstance) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & service_instance_annotations != 0 {
                var value json.RawMessage
...
func (obj *ServiceInstance) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= service_instance_annotations
                        }
                        break
                case "display_name":
