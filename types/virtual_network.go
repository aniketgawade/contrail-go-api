...
func (obj *VirtualNetwork) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_network_tag_refs == 0) {
...
func (obj *VirtualNetwork) AddTag(
        ...
        if obj.modified & virtual_network_tag_refs == 0 {
...
func (obj *VirtualNetwork) ClearTag() {
        if (obj.valid & virtual_network_tag_refs != 0) &&
           (obj.modified & virtual_network_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *VirtualNetwork) readFirewallRuleBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_network_firewall_rule_back_refs == 0) {
