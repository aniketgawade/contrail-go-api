...
func (obj *ForwardingClass) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= forwarding_class_annotations
}
...
func (obj *ForwardingClass) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & forwarding_class_tag_refs == 0) {
...
func (obj *ForwardingClass) AddTag(
        ...
        if obj.modified & forwarding_class_tag_refs == 0 {
...
func (obj *ForwardingClass) ClearTag() {
        if (obj.valid & forwarding_class_tag_refs != 0) &&
           (obj.modified & forwarding_class_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ForwardingClass) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & forwarding_class_annotations != 0 {
                var value json.RawMessage
...
func (obj *ForwardingClass) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= forwarding_class_annotations
                        }
                        break
                case "display_name":
