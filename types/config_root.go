...
func (obj *ConfigRoot) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= config_root_annotations
}
...
func (obj *ConfigRoot) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & config_root_tag_refs == 0) {
...
func (obj *ConfigRoot) AddTag(
        ...
        if obj.modified & config_root_tag_refs == 0 {
...
func (obj *ConfigRoot) ClearTag() {
        if (obj.valid & config_root_tag_refs != 0) &&
           (obj.modified & config_root_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ConfigRoot) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & config_root_annotations != 0 {
                var value json.RawMessage
...
func (obj *ConfigRoot) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= config_root_annotations
                        }
                        break
                case "display_name":
