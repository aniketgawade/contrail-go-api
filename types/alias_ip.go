...
func (obj *AliasIp) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= alias_ip_annotations
}
...
func (obj *AliasIp) AddTag(
        ...
        if obj.modified & alias_ip_tag_refs == 0 {
...
func (obj *AliasIp) ClearTag() {
        if (obj.valid & alias_ip_tag_refs != 0) &&
           (obj.modified & alias_ip_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *AliasIp) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & alias_ip_annotations != 0 {
                var value json.RawMessage
...
func (obj *AliasIp) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= alias_ip_annotations
                        }
                        break
                case "display_name":
