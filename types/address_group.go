...
const (
	address_group_address_group_prefix uint64 = 1 << iota
...
func (obj *AddressGroup) SetAddressGroupPrefix(value *SubnetListType) {
        ...
        obj.modified |= address_group_address_group_prefix
}
...
func (obj *AddressGroup) SetIdPerms(value *IdPermsType) {
        obj.id_perms = *value
        obj.modified |= address_group_id_perms
}
...
func (obj *AddressGroup) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= address_group_perms2
}
...
func (obj *AddressGroup) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= address_group_annotations
}
...
func (obj *AddressGroup) SetDisplayName(value string) {
        ...
        obj.modified |= address_group_display_name
}

func (obj *AddressGroup) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & address_group_tag_refs == 0) {
...
func (obj *AddressGroup) AddTag(
        ...
        if obj.modified & address_group_tag_refs == 0 {
...
func (obj *AddressGroup) ClearTag() {
        if (obj.valid & address_group_tag_refs != 0) &&
           (obj.modified & address_group_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *AddressGroup) readFirewallRuleBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & address_group_firewall_rule_back_refs == 0) {
...
func (obj *AddressGroup) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & address_group_address_group_prefix != 0 {
        ...
        if obj.modified & address_group_id_perms != 0 {
                var value json.RawMessage
        ...
        if obj.modified & address_group_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & address_group_annotations != 0 {
                var value json.RawMessage
        ...
        if obj.modified & address_group_display_name != 0 {
                var value json.RawMessage
...
func (obj *AddressGroup) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "address_group_prefix":
                        ...
                        if err == nil {
                                obj.valid |= address_group_address_group_prefix
                        }
                        break
                case "id_perms":
                        err = json.Unmarshal(value, &obj.id_perms)
                        if err == nil {
                                obj.valid |= address_group_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= address_group_perms2
                        }
                        break
                case "annotations":
                        err = json.Unmarshal(value, &obj.annotations)
                        if err == nil {
                                obj.valid |= address_group_annotations
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= address_group_display_name
                        }
                        break
                case "tag_refs":
