...
func (obj *PhysicalRouter) SetPhysicalRouterLoopbackIp(value string) {
        ...
        obj.modified |= physical_router_physical_router_loopback_ip
}
...
func (obj *PhysicalRouter) SetPhysicalRouterRole(value string) {
        ...
        obj.modified |= physical_router_physical_router_role
}
...
func (obj *PhysicalRouter) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & physical_router_tag_refs == 0) {
...
func (obj *PhysicalRouter) AddTag(
        ...
        if obj.modified & physical_router_tag_refs == 0 {
...
func (obj *PhysicalRouter) ClearTag() {
        if (obj.valid & physical_router_tag_refs != 0) &&
           (obj.modified & physical_router_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *PhysicalRouter) readLogicalRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & physical_router_logical_router_back_refs == 0) {
...
func (obj *PhysicalRouter) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & physical_router_physical_router_loopback_ip != 0 {
                var value json.RawMessage
        ...
        if obj.modified & physical_router_physical_router_role != 0 {
                var value json.RawMessage
...
func (obj *PhysicalRouter) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "physical_router_loopback_ip":
                        ...
                        if err == nil {
                                obj.valid |= physical_router_physical_router_loopback_ip
                        }
                        break
                ...
                case "physical_router_role":
                        ...
                        if err == nil {
                                obj.valid |= physical_router_physical_router_role
                        }
                        break
