...
func (obj *AnalyticsNode) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & analytics_node_tag_refs == 0) {
...
func (obj *AnalyticsNode) AddTag(
        ...
        if obj.modified & analytics_node_tag_refs == 0 {
...
func (obj *AnalyticsNode) ClearTag() {
        if (obj.valid & analytics_node_tag_refs != 0) &&
           (obj.modified & analytics_node_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
