...
func (obj *VirtualRouter) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_router_tag_refs == 0) {
...
func (obj *VirtualRouter) AddTag(
        ...
        if obj.modified & virtual_router_tag_refs == 0 {
...
func (obj *VirtualRouter) ClearTag() {
        if (obj.valid & virtual_router_tag_refs != 0) &&
           (obj.modified & virtual_router_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
