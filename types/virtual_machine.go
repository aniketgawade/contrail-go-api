...
func (obj *VirtualMachine) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_machine_tag_refs == 0) {
...
func (obj *VirtualMachine) AddTag(
        ...
        if obj.modified & virtual_machine_tag_refs == 0 {
...
func (obj *VirtualMachine) ClearTag() {
        if (obj.valid & virtual_machine_tag_refs != 0) &&
           (obj.modified & virtual_machine_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
