...
const (
	global_qos_config_control_traffic_dscp uint64 = 1 << iota
...
func (obj *GlobalQosConfig) SetControlTrafficDscp(value *ControlTrafficDscpType) {
        ...
        obj.modified |= global_qos_config_control_traffic_dscp
}
...
func (obj *GlobalQosConfig) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= global_qos_config_annotations
}
...
func (obj *GlobalQosConfig) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & global_qos_config_tag_refs == 0) {
...
func (obj *GlobalQosConfig) AddTag(
        ...
        if obj.modified & global_qos_config_tag_refs == 0 {
...
func (obj *GlobalQosConfig) ClearTag() {
        if (obj.valid & global_qos_config_tag_refs != 0) &&
           (obj.modified & global_qos_config_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *GlobalQosConfig) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & global_qos_config_control_traffic_dscp != 0 {
        ...
        if obj.modified & global_qos_config_annotations != 0 {
                var value json.RawMessage
...
func (obj *GlobalQosConfig) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "control_traffic_dscp":
                        ...
                        if err == nil {
                                obj.valid |= global_qos_config_control_traffic_dscp
                        }
                        break
                case "id_perms":
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= global_qos_config_annotations
                        }
                        break
                case "display_name":
