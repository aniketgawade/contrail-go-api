...
func (obj *ServiceAppliance) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= service_appliance_annotations
}
...
func (obj *ServiceAppliance) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & service_appliance_tag_refs == 0) {
...
func (obj *ServiceAppliance) AddTag(
        ...
        if obj.modified & service_appliance_tag_refs == 0 {
...
func (obj *ServiceAppliance) ClearTag() {
        if (obj.valid & service_appliance_tag_refs != 0) &&
           (obj.modified & service_appliance_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ServiceAppliance) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & service_appliance_annotations != 0 {
                var value json.RawMessage
...
func (obj *ServiceAppliance) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= service_appliance_annotations
                        }
                        break
                case "display_name":
