...
func (obj *LoadbalancerPool) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_pool_tag_refs == 0) {
...
func (obj *LoadbalancerPool) AddTag(
        ...
        if obj.modified & loadbalancer_pool_tag_refs == 0 {
...
func (obj *LoadbalancerPool) ClearTag() {
        if (obj.valid & loadbalancer_pool_tag_refs != 0) &&
           (obj.modified & loadbalancer_pool_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
