...
func (obj *ProviderAttachment) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & provider_attachment_tag_refs == 0) {
...
func (obj *ProviderAttachment) AddTag(
        ...
        if obj.modified & provider_attachment_tag_refs == 0 {
...
func (obj *ProviderAttachment) ClearTag() {
        if (obj.valid & provider_attachment_tag_refs != 0) &&
           (obj.modified & provider_attachment_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
