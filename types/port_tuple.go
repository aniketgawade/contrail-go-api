...
func (obj *PortTuple) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= port_tuple_annotations
}
...
func (obj *PortTuple) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & port_tuple_tag_refs == 0) {
...
func (obj *PortTuple) AddTag(
        ...
        if obj.modified & port_tuple_tag_refs == 0 {
...
func (obj *PortTuple) ClearTag() {
        if (obj.valid & port_tuple_tag_refs != 0) &&
           (obj.modified & port_tuple_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *PortTuple) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & port_tuple_annotations != 0 {
                var value json.RawMessage
...
func (obj *PortTuple) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= port_tuple_annotations
                        }
                        break
                case "display_name":
