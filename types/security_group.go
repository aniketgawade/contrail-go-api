...
func (obj *SecurityGroup) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_group_tag_refs == 0) {
...
func (obj *SecurityGroup) AddTag(
        ...
        if obj.modified & security_group_tag_refs == 0 {
...
func (obj *SecurityGroup) ClearTag() {
        if (obj.valid & security_group_tag_refs != 0) &&
           (obj.modified & security_group_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
