...
func (obj *InterfaceRouteTable) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= interface_route_table_annotations
}
...
func (obj *InterfaceRouteTable) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & interface_route_table_tag_refs == 0) {
...
func (obj *InterfaceRouteTable) AddTag(
        ...
        if obj.modified & interface_route_table_tag_refs == 0 {
...
func (obj *InterfaceRouteTable) ClearTag() {
        if (obj.valid & interface_route_table_tag_refs != 0) &&
           (obj.modified & interface_route_table_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *InterfaceRouteTable) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & interface_route_table_annotations != 0 {
                var value json.RawMessage
...
func (obj *InterfaceRouteTable) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= interface_route_table_annotations
                        }
                        break
                case "display_name":
