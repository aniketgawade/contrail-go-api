...
func (obj *RoutingPolicy) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= routing_policy_annotations
}
...
func (obj *RoutingPolicy) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & routing_policy_tag_refs == 0) {
...
func (obj *RoutingPolicy) AddTag(
        ...
        if obj.modified & routing_policy_tag_refs == 0 {
...
func (obj *RoutingPolicy) ClearTag() {
        if (obj.valid & routing_policy_tag_refs != 0) &&
           (obj.modified & routing_policy_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *RoutingPolicy) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & routing_policy_annotations != 0 {
                var value json.RawMessage
...
func (obj *RoutingPolicy) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= routing_policy_annotations
                        }
                        break
                case "display_name":
