...
func (obj *FloatingIpPool) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & floating_ip_pool_tag_refs == 0) {
...
func (obj *FloatingIpPool) AddTag(
        ...
        if obj.modified & floating_ip_pool_tag_refs == 0 {
...
func (obj *FloatingIpPool) ClearTag() {
        if (obj.valid & floating_ip_pool_tag_refs != 0) &&
           (obj.modified & floating_ip_pool_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
