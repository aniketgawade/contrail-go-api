...
func (obj *CustomerAttachment) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= customer_attachment_annotations
}
...
func (obj *CustomerAttachment) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & customer_attachment_tag_refs == 0) {
...
func (obj *CustomerAttachment) AddTag(
        ...
        if obj.modified & customer_attachment_tag_refs == 0 {
...
func (obj *CustomerAttachment) ClearTag() {
        if (obj.valid & customer_attachment_tag_refs != 0) &&
           (obj.modified & customer_attachment_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *CustomerAttachment) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & customer_attachment_annotations != 0 {
                var value json.RawMessage
...
func (obj *CustomerAttachment) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= customer_attachment_annotations
                        }
                        break
                case "display_name":
