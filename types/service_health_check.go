...
func (obj *ServiceHealthCheck) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= service_health_check_annotations
}
...
func (obj *ServiceHealthCheck) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & service_health_check_tag_refs == 0) {
...
func (obj *ServiceHealthCheck) AddTag(
        ...
        if obj.modified & service_health_check_tag_refs == 0 {
...
func (obj *ServiceHealthCheck) ClearTag() {
        if (obj.valid & service_health_check_tag_refs != 0) &&
           (obj.modified & service_health_check_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ServiceHealthCheck) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & service_health_check_annotations != 0 {
                var value json.RawMessage
...
func (obj *ServiceHealthCheck) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= service_health_check_annotations
                        }
                        break
                case "display_name":
