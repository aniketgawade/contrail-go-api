...
func (obj *QosConfig) SetDefaultForwardingClassId(value int) {
        ...
        obj.modified |= qos_config_default_forwarding_class_id
}
...
func (obj *QosConfig) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= qos_config_annotations
}
...
func (obj *QosConfig) readGlobalSystemConfigRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & qos_config_global_system_config_refs == 0) {
...
func (obj *QosConfig) AddGlobalSystemConfig(
        ...
        if obj.modified & qos_config_global_system_config_refs == 0 {
...
func (obj *QosConfig) ClearGlobalSystemConfig() {
        if (obj.valid & qos_config_global_system_config_refs != 0) &&
           (obj.modified & qos_config_global_system_config_refs == 0) {
                obj.storeReferenceBase("global-system-config", obj.global_system_config_refs)
        }
...
func (obj *QosConfig) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & qos_config_tag_refs == 0) {
...
func (obj *QosConfig) AddTag(
        ...
        if obj.modified & qos_config_tag_refs == 0 {
...
func (obj *QosConfig) ClearTag() {
        if (obj.valid & qos_config_tag_refs != 0) &&
           (obj.modified & qos_config_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *QosConfig) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & qos_config_default_forwarding_class_id != 0 {
                var value json.RawMessage
        ...
        if obj.modified & qos_config_annotations != 0 {
                var value json.RawMessage
...
func (obj *QosConfig) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "default_forwarding_class_id":
                        ...
                        if err == nil {
                                obj.valid |= qos_config_default_forwarding_class_id
                        }
                        break
                case "id_perms":
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= qos_config_annotations
                        }
                        break
                case "display_name":
