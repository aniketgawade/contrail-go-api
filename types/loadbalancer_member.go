...
func (obj *LoadbalancerMember) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_member_tag_refs == 0) {
...
func (obj *LoadbalancerMember) AddTag(
        ...
        if obj.modified & loadbalancer_member_tag_refs == 0 {
...
func (obj *LoadbalancerMember) ClearTag() {
        if (obj.valid & loadbalancer_member_tag_refs != 0) &&
           (obj.modified & loadbalancer_member_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
