...
const (
	...
	global_vrouter_config_bgp_as_service_global_config
...
type GlobalVrouterConfig struct {
	...
	bgp_as_service_global_config BgpAsServiceGlobalConfig
...
func (obj *GlobalVrouterConfig) GetBgpAsServiceGlobalConfig() BgpAsServiceGlobalConfig {
        return obj.bgp_as_service_global_config
}

func (obj *GlobalVrouterConfig) SetBgpAsServiceGlobalConfig(value *BgpAsServiceGlobalConfig) {
        obj.bgp_as_service_global_config = *value
        obj.modified |= global_vrouter_config_bgp_as_service_global_config
}
...
func (obj *GlobalVrouterConfig) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & global_vrouter_config_tag_refs == 0) {
...
func (obj *GlobalVrouterConfig) AddTag(
        ...
        if obj.modified & global_vrouter_config_tag_refs == 0 {
...
func (obj *GlobalVrouterConfig) ClearTag() {
        if (obj.valid & global_vrouter_config_tag_refs != 0) &&
           (obj.modified & global_vrouter_config_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *GlobalVrouterConfig) readApplicationPolicySetBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & global_vrouter_config_application_policy_set_back_refs == 0) {
...
func (obj *GlobalVrouterConfig) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & global_vrouter_config_bgp_as_service_global_config != 0 {
                var value json.RawMessage
                value, err := json.Marshal(&obj.bgp_as_service_global_config)
                if err != nil {
                        return nil, err
                }
                msg["bgp_as_service_global_config"] = &value
        }
...
func (obj *GlobalVrouterConfig) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "enable_security_logging":
                        ...
                        break
                case "bgp_as_service_global_config":
                        err = json.Unmarshal(value, &obj.bgp_as_service_global_config)
                        if err == nil {
                                obj.valid |= global_vrouter_config_bgp_as_service_global_config
                        }
                        break
