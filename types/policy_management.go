...
const (
	policy_management_id_perms uint64 = 1 << iota
...
func (obj *PolicyManagement) SetIdPerms(value *IdPermsType) {
        obj.id_perms = *value
        obj.modified |= policy_management_id_perms
}
...
func (obj *PolicyManagement) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= policy_management_perms2
}
...
func (obj *PolicyManagement) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= policy_management_annotations
}
...
func (obj *PolicyManagement) SetDisplayName(value string) {
        ...
        obj.modified |= policy_management_display_name
}

func (obj *PolicyManagement) readServiceGroups() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_service_groups == 0) {
...
func (obj *PolicyManagement) readAddressGroups() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_address_groups == 0) {
...
func (obj *PolicyManagement) readFirewallRules() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_firewall_rules == 0) {
...
func (obj *PolicyManagement) readFirewallPolicys() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_firewall_policys == 0) {
...
func (obj *PolicyManagement) readApplicationPolicySets() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_application_policy_sets == 0) {
...
func (obj *PolicyManagement) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & policy_management_tag_refs == 0) {
...
func (obj *PolicyManagement) AddTag(
        ...
        if obj.modified & policy_management_tag_refs == 0 {
...
func (obj *PolicyManagement) ClearTag() {
        if (obj.valid & policy_management_tag_refs != 0) &&
           (obj.modified & policy_management_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *PolicyManagement) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & policy_management_id_perms != 0 {
        ...
        if obj.modified & policy_management_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & policy_management_annotations != 0 {
                var value json.RawMessage
        ...
        if obj.modified & policy_management_display_name != 0 {
                var value json.RawMessage
...
func (obj *PolicyManagement) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "id_perms":
                        ...
                        if err == nil {
                                obj.valid |= policy_management_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= policy_management_perms2
                        }
                        break
                case "annotations":
                        err = json.Unmarshal(value, &obj.annotations)
                        if err == nil {
                                obj.valid |= policy_management_annotations
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= policy_management_display_name
                        }
                        break
                case "service_groups":
