...
func (obj *Alarm) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= alarm_annotations
}
...
func (obj *Alarm) AddTag(
        ...
        if obj.modified & alarm_tag_refs == 0 {
...
func (obj *Alarm) ClearTag() {
        if (obj.valid & alarm_tag_refs != 0) &&
           (obj.modified & alarm_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *Alarm) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & alarm_annotations != 0 {
                var value json.RawMessage
