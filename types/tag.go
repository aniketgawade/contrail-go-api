...
func (obj *Tag) GetTagType() string {
        return obj.tag_type
}

func (obj *Tag) SetTagType(value string) {
        obj.tag_type = value
        obj.modified |= tag_tag_type
}
...
func (obj *Tag) SetTagValue(value string) {
        obj.tag_value = value
        obj.modified |= tag_tag_value
}

func (obj *Tag) GetTagId() int {
        return obj.tag_id
}

func (obj *Tag) SetTagId(value int) {
        obj.tag_id = value
        obj.modified |= tag_tag_id
}
...
func (obj *Tag) SetDisplayName(value string) {
        ...
        obj.modified |= tag_display_name
}

func (obj *Tag) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_tag_refs == 0) {
...
func (obj *Tag) AddTag(
        ...
        if obj.modified & tag_tag_refs == 0 {
...
func (obj *Tag) ClearTag() {
        if (obj.valid & tag_tag_refs != 0) &&
           (obj.modified & tag_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *Tag) readDomainBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_domain_back_refs == 0) {
...
func (obj *Tag) readGlobalVrouterConfigBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_global_vrouter_config_back_refs == 0) {
...
func (obj *Tag) readAddressGroupBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_address_group_back_refs == 0) {
...
func (obj *Tag) readInstanceIpBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_instance_ip_back_refs == 0) {
...
func (obj *Tag) readFloatingIpPoolBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_floating_ip_pool_back_refs == 0) {
...
func (obj *Tag) readLoadbalancerPoolBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_loadbalancer_pool_back_refs == 0) {
...
func (obj *Tag) readVirtualDnsRecordBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_DNS_record_back_refs == 0) {
...
func (obj *Tag) readRouteTargetBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_route_target_back_refs == 0) {
...
func (obj *Tag) readBridgeDomainBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_bridge_domain_back_refs == 0) {
...
func (obj *Tag) readDiscoveryServiceAssignmentBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_discovery_service_assignment_back_refs == 0) {
...
func (obj *Tag) readFloatingIpBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_floating_ip_back_refs == 0) {
...
func (obj *Tag) readAliasIpBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_alias_ip_back_refs == 0) {
...
func (obj *Tag) readNetworkPolicyBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_network_policy_back_refs == 0) {
...
func (obj *Tag) readPhysicalRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_physical_router_back_refs == 0) {
...
func (obj *Tag) readBgpRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_bgp_router_back_refs == 0) {
...
func (obj *Tag) readApiAccessListBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_api_access_list_back_refs == 0) {
...
func (obj *Tag) readVirtualRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_router_back_refs == 0) {
...
func (obj *Tag) readConfigRootBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_config_root_back_refs == 0) {
...
func (obj *Tag) readSubnetBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_subnet_back_refs == 0) {
...
func (obj *Tag) readAlarmBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_alarm_back_refs == 0) {
...
func (obj *Tag) readPolicyManagementBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_policy_management_back_refs == 0) {
...
func (obj *Tag) readGlobalSystemConfigBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_global_system_config_back_refs == 0) {
...
func (obj *Tag) readServiceApplianceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_appliance_back_refs == 0) {
...
func (obj *Tag) readRoutingPolicyBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_routing_policy_back_refs == 0) {
...
func (obj *Tag) readNamespaceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_namespace_back_refs == 0) {
...
func (obj *Tag) readForwardingClassBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_forwarding_class_back_refs == 0) {
...
func (obj *Tag) readServiceInstanceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_instance_back_refs == 0) {
...
func (obj *Tag) readServiceGroupBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_group_back_refs == 0) {
...
func (obj *Tag) readRouteTableBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_route_table_back_refs == 0) {
...
func (obj *Tag) readApplicationPolicySetBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_application_policy_set_back_refs == 0) {
...
func (obj *Tag) readPhysicalInterfaceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_physical_interface_back_refs == 0) {
...
func (obj *Tag) readAccessControlListBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_access_control_list_back_refs == 0) {
...
func (obj *Tag) readBgpAsAServiceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_bgp_as_a_service_back_refs == 0) {
...
func (obj *Tag) readPortTupleBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_port_tuple_back_refs == 0) {
...
func (obj *Tag) readSecurityLoggingObjectBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_security_logging_object_back_refs == 0) {
...
func (obj *Tag) readAnalyticsNodeBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_analytics_node_back_refs == 0) {
...
func (obj *Tag) readVirtualDnsBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_DNS_back_refs == 0) {
...
func (obj *Tag) readCustomerAttachmentBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_customer_attachment_back_refs == 0) {
...
func (obj *Tag) readServiceApplianceSetBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_appliance_set_back_refs == 0) {
...
func (obj *Tag) readConfigNodeBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_config_node_back_refs == 0) {
...
func (obj *Tag) readQosQueueBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_qos_queue_back_refs == 0) {
...
func (obj *Tag) readVirtualMachineBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_machine_back_refs == 0) {
...
func (obj *Tag) readInterfaceRouteTableBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_interface_route_table_back_refs == 0) {
...
func (obj *Tag) readServiceTemplateBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_template_back_refs == 0) {
...
func (obj *Tag) readDsaRuleBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_dsa_rule_back_refs == 0) {
...
func (obj *Tag) readFirewallPolicyBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_firewall_policy_back_refs == 0) {
...
func (obj *Tag) readFirewallRuleBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_firewall_rule_back_refs == 0) {
...
func (obj *Tag) readBgpvpnBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_bgpvpn_back_refs == 0) {
...
func (obj *Tag) readGlobalQosConfigBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_global_qos_config_back_refs == 0) {
...
func (obj *Tag) readVirtualIpBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_ip_back_refs == 0) {
...
func (obj *Tag) readLoadbalancerMemberBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_loadbalancer_member_back_refs == 0) {
...
func (obj *Tag) readSecurityGroupBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_security_group_back_refs == 0) {
...
func (obj *Tag) readServiceHealthCheckBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_service_health_check_back_refs == 0) {
...
func (obj *Tag) readQosConfigBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_qos_config_back_refs == 0) {
...
func (obj *Tag) readProviderAttachmentBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_provider_attachment_back_refs == 0) {
...
func (obj *Tag) readVirtualMachineInterfaceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_machine_interface_back_refs == 0) {
...
func (obj *Tag) readLoadbalancerHealthmonitorBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_loadbalancer_healthmonitor_back_refs == 0) {
...
func (obj *Tag) readLoadbalancerListenerBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_loadbalancer_listener_back_refs == 0) {
...
func (obj *Tag) readVirtualNetworkBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_virtual_network_back_refs == 0) {
...
func (obj *Tag) readProjectBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_project_back_refs == 0) {
...
func (obj *Tag) readLogicalInterfaceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_logical_interface_back_refs == 0) {
...
func (obj *Tag) readLoadbalancerBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_loadbalancer_back_refs == 0) {
...
func (obj *Tag) readDatabaseNodeBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_database_node_back_refs == 0) {
...
func (obj *Tag) readRoutingInstanceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_routing_instance_back_refs == 0) {
...
func (obj *Tag) readAliasIpPoolBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_alias_ip_pool_back_refs == 0) {
...
func (obj *Tag) readNetworkIpamBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_network_ipam_back_refs == 0) {
...
func (obj *Tag) readRouteAggregateBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_route_aggregate_back_refs == 0) {
...
func (obj *Tag) readLogicalRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & tag_logical_router_back_refs == 0) {
...
func (obj *Tag) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & tag_tag_type != 0 {
                var value json.RawMessage
                value, err := json.Marshal(&obj.tag_type)
                if err != nil {
                        return nil, err
                }
                msg["tag_type"] = &value
        ...
        if obj.modified & tag_tag_value != 0 {
                var value json.RawMessage
        ...
        if obj.modified & tag_id_perms != 0 {
                var value json.RawMessage
        ...
        if obj.modified & tag_annotations != 0 {
                var value json.RawMessage
        ...
        if obj.modified & tag_display_name != 0 {
                var value json.RawMessage
...
func (obj *Tag) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                switch key {
                case "tag_type":
                        err = json.Unmarshal(value, &obj.tag_type)
                        if err == nil {
                                obj.valid |= tag_tag_type
                        }
                        break
                case "tag_value":
                        err = json.Unmarshal(value, &obj.tag_value)
                        if err == nil {
                                obj.valid |= tag_tag_value
                        }
                        break
                case "tag_id":
                        err = json.Unmarshal(value, &obj.tag_id)
                        if err == nil {
                                obj.valid |= tag_tag_id
                        }
                        break
                case "id_perms":
                        err = json.Unmarshal(value, &obj.id_perms)
                        if err == nil {
                                obj.valid |= tag_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= tag_perms2
                        }
                        break
                case "annotations":
                        err = json.Unmarshal(value, &obj.annotations)
                        if err == nil {
                                obj.valid |= tag_annotations
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= tag_display_name
                        }
                        break
                case "tag_refs":
