...
func (obj *ApiAccessList) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= api_access_list_annotations
}
...
func (obj *ApiAccessList) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & api_access_list_tag_refs == 0) {
...
func (obj *ApiAccessList) AddTag(
        ...
        if obj.modified & api_access_list_tag_refs == 0 {
...
func (obj *ApiAccessList) ClearTag() {
        if (obj.valid & api_access_list_tag_refs != 0) &&
           (obj.modified & api_access_list_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ApiAccessList) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & api_access_list_annotations != 0 {
                var value json.RawMessage
...
func (obj *ApiAccessList) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= api_access_list_annotations
                        }
                        break
                case "display_name":
