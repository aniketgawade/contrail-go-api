...
func (obj *VirtualMachineInterface) SetPortSecurityEnabled(value bool) {
        ...
        obj.modified |= virtual_machine_interface_port_security_enabled
}
...
func (obj *VirtualMachineInterface) SetVlanTagBasedBridgeDomain(value bool) {
        ...
        obj.modified |= virtual_machine_interface_vlan_tag_based_bridge_domain
}
...
func (obj *VirtualMachineInterface) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= virtual_machine_interface_annotations
}
...
func (obj *VirtualMachineInterface) readSecurityLoggingObjectRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_machine_interface_security_logging_object_refs == 0) {
...
func (obj *VirtualMachineInterface) AddSecurityLoggingObject(
        ...
        if obj.modified & virtual_machine_interface_security_logging_object_refs == 0 {
...
func (obj *VirtualMachineInterface) ClearSecurityLoggingObject() {
        if (obj.valid & virtual_machine_interface_security_logging_object_refs != 0) &&
           (obj.modified & virtual_machine_interface_security_logging_object_refs == 0) {
                obj.storeReferenceBase("security-logging-object", obj.security_logging_object_refs)
        }
...
func (obj *VirtualMachineInterface) readBridgeDomainRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_machine_interface_bridge_domain_refs == 0) {
...
func (obj *VirtualMachineInterface) AddBridgeDomain(
        ...
        if obj.modified & virtual_machine_interface_bridge_domain_refs == 0 {
...
func (obj *VirtualMachineInterface) ClearBridgeDomain() {
        if (obj.valid & virtual_machine_interface_bridge_domain_refs != 0) &&
           (obj.modified & virtual_machine_interface_bridge_domain_refs == 0) {
                obj.storeReferenceBase("bridge-domain", obj.bridge_domain_refs)
        }
...
func (obj *VirtualMachineInterface) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & virtual_machine_interface_tag_refs == 0) {
...
func (obj *VirtualMachineInterface) AddTag(
        ...
        if obj.modified & virtual_machine_interface_tag_refs == 0 {
...
func (obj *VirtualMachineInterface) ClearTag() {
        if (obj.valid & virtual_machine_interface_tag_refs != 0) &&
           (obj.modified & virtual_machine_interface_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *VirtualMachineInterface) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & virtual_machine_interface_port_security_enabled != 0 {
                var value json.RawMessage
        ...
        if obj.modified & virtual_machine_interface_vlan_tag_based_bridge_domain != 0 {
                var value json.RawMessage
        ...
        if obj.modified & virtual_machine_interface_annotations != 0 {
                var value json.RawMessage
...
func (obj *VirtualMachineInterface) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "port_security_enabled":
                        ...
                        if err == nil {
                                obj.valid |= virtual_machine_interface_port_security_enabled
                        }
                        break
                ...
                case "vlan_tag_based_bridge_domain":
                        ...
                        if err == nil {
                                obj.valid |= virtual_machine_interface_vlan_tag_based_bridge_domain
                        }
                        break
                case "id_perms":
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= virtual_machine_interface_annotations
                        }
                        break
                case "display_name":
