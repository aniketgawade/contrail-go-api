...
func (obj *LogicalInterface) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & logical_interface_tag_refs == 0) {
...
func (obj *LogicalInterface) AddTag(
        ...
        if obj.modified & logical_interface_tag_refs == 0 {
...
func (obj *LogicalInterface) ClearTag() {
        if (obj.valid & logical_interface_tag_refs != 0) &&
           (obj.modified & logical_interface_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
