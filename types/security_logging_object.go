...
const (
	security_logging_object_security_logging_object_rules uint64 = 1 << iota
...
func (obj *SecurityLoggingObject) SetSecurityLoggingObjectRules(value *SecurityLoggingObjectRuleListType) {
        ...
        obj.modified |= security_logging_object_security_logging_object_rules
}
...
func (obj *SecurityLoggingObject) SetSecurityLoggingObjectRate(value int) {
        ...
        obj.modified |= security_logging_object_security_logging_object_rate
}
...
func (obj *SecurityLoggingObject) SetIdPerms(value *IdPermsType) {
        obj.id_perms = *value
        obj.modified |= security_logging_object_id_perms
}
...
func (obj *SecurityLoggingObject) SetPerms2(value *PermType2) {
        obj.perms2 = *value
        obj.modified |= security_logging_object_perms2
}
...
func (obj *SecurityLoggingObject) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= security_logging_object_annotations
}
...
func (obj *SecurityLoggingObject) SetDisplayName(value string) {
        ...
        obj.modified |= security_logging_object_display_name
}

func (obj *SecurityLoggingObject) readNetworkPolicyRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_logging_object_network_policy_refs == 0) {
...
func (obj *SecurityLoggingObject) AddNetworkPolicy(
        ...
        if obj.modified & security_logging_object_network_policy_refs == 0 {
...
func (obj *SecurityLoggingObject) ClearNetworkPolicy() {
        if (obj.valid & security_logging_object_network_policy_refs != 0) &&
           (obj.modified & security_logging_object_network_policy_refs == 0) {
                obj.storeReferenceBase("network-policy", obj.network_policy_refs)
        }
...
func (obj *SecurityLoggingObject) readSecurityGroupRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_logging_object_security_group_refs == 0) {
...
func (obj *SecurityLoggingObject) AddSecurityGroup(
        ...
        if obj.modified & security_logging_object_security_group_refs == 0 {
...
func (obj *SecurityLoggingObject) ClearSecurityGroup() {
        if (obj.valid & security_logging_object_security_group_refs != 0) &&
           (obj.modified & security_logging_object_security_group_refs == 0) {
                obj.storeReferenceBase("security-group", obj.security_group_refs)
        }
...
func (obj *SecurityLoggingObject) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_logging_object_tag_refs == 0) {
...
func (obj *SecurityLoggingObject) AddTag(
        ...
        if obj.modified & security_logging_object_tag_refs == 0 {
...
func (obj *SecurityLoggingObject) ClearTag() {
        if (obj.valid & security_logging_object_tag_refs != 0) &&
           (obj.modified & security_logging_object_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *SecurityLoggingObject) readVirtualNetworkBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_logging_object_virtual_network_back_refs == 0) {
...
func (obj *SecurityLoggingObject) readVirtualMachineInterfaceBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & security_logging_object_virtual_machine_interface_back_refs == 0) {
...
func (obj *SecurityLoggingObject) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & security_logging_object_security_logging_object_rules != 0 {
        ...
        if obj.modified & security_logging_object_security_logging_object_rate != 0 {
                var value json.RawMessage
        ...
        if obj.modified & security_logging_object_id_perms != 0 {
                var value json.RawMessage
        ...
        if obj.modified & security_logging_object_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & security_logging_object_annotations != 0 {
                var value json.RawMessage
        ...
        if obj.modified & security_logging_object_display_name != 0 {
                var value json.RawMessage
...
func (obj *SecurityLoggingObject) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "security_logging_object_rules":
                        ...
                        if err == nil {
                                obj.valid |= security_logging_object_security_logging_object_rules
                        }
                        break
                case "security_logging_object_rate":
                        err = json.Unmarshal(value, &obj.security_logging_object_rate)
                        if err == nil {
                                obj.valid |= security_logging_object_security_logging_object_rate
                        }
                        break
                case "id_perms":
                        err = json.Unmarshal(value, &obj.id_perms)
                        if err == nil {
                                obj.valid |= security_logging_object_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= security_logging_object_perms2
                        }
                        break
                case "annotations":
                        err = json.Unmarshal(value, &obj.annotations)
                        if err == nil {
                                obj.valid |= security_logging_object_annotations
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= security_logging_object_display_name
                        }
                        break
                case "tag_refs":
