...
const (
	bgpvpn_route_target_list uint64 = 1 << iota
...
func (obj *Bgpvpn) SetRouteTargetList(value *RouteTargetList) {
        ...
        obj.modified |= bgpvpn_route_target_list
}
...
func (obj *Bgpvpn) SetImportRouteTargetList(value *RouteTargetList) {
        ...
        obj.modified |= bgpvpn_import_route_target_list
}
...
func (obj *Bgpvpn) SetExportRouteTargetList(value *RouteTargetList) {
        ...
        obj.modified |= bgpvpn_export_route_target_list
}
...
func (obj *Bgpvpn) SetBgpvpnType(value string) {
        ...
        obj.modified |= bgpvpn_bgpvpn_type
}
...
func (obj *Bgpvpn) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= bgpvpn_annotations
}
...
func (obj *Bgpvpn) SetDisplayName(value string) {
        ...
        obj.modified |= bgpvpn_display_name
}

func (obj *Bgpvpn) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & bgpvpn_tag_refs == 0) {
...
func (obj *Bgpvpn) AddTag(
        ...
        if obj.modified & bgpvpn_tag_refs == 0 {
...
func (obj *Bgpvpn) ClearTag() {
        if (obj.valid & bgpvpn_tag_refs != 0) &&
           (obj.modified & bgpvpn_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *Bgpvpn) readVirtualNetworkBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & bgpvpn_virtual_network_back_refs == 0) {
...
func (obj *Bgpvpn) readLogicalRouterBackRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & bgpvpn_logical_router_back_refs == 0) {
...
func (obj *Bgpvpn) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & bgpvpn_route_target_list != 0 {
        ...
        if obj.modified & bgpvpn_import_route_target_list != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_export_route_target_list != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_bgpvpn_type != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_id_perms != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_perms2 != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_annotations != 0 {
                var value json.RawMessage
        ...
        if obj.modified & bgpvpn_display_name != 0 {
                var value json.RawMessage
...
func (obj *Bgpvpn) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "route_target_list":
                        ...
                        if err == nil {
                                obj.valid |= bgpvpn_route_target_list
                        }
                        break
                case "import_route_target_list":
                        err = json.Unmarshal(value, &obj.import_route_target_list)
                        if err == nil {
                                obj.valid |= bgpvpn_import_route_target_list
                        }
                        break
                case "export_route_target_list":
                        err = json.Unmarshal(value, &obj.export_route_target_list)
                        if err == nil {
                                obj.valid |= bgpvpn_export_route_target_list
                        }
                        break
                case "bgpvpn_type":
                        err = json.Unmarshal(value, &obj.bgpvpn_type)
                        if err == nil {
                                obj.valid |= bgpvpn_bgpvpn_type
                        }
                        break
                case "id_perms":
                        err = json.Unmarshal(value, &obj.id_perms)
                        if err == nil {
                                obj.valid |= bgpvpn_id_perms
                        }
                        break
                case "perms2":
                        err = json.Unmarshal(value, &obj.perms2)
                        if err == nil {
                                obj.valid |= bgpvpn_perms2
                        }
                        break
                case "annotations":
                        err = json.Unmarshal(value, &obj.annotations)
                        if err == nil {
                                obj.valid |= bgpvpn_annotations
                        }
                        break
                case "display_name":
                        err = json.Unmarshal(value, &obj.display_name)
                        if err == nil {
                                obj.valid |= bgpvpn_display_name
                        }
                        break
                case "tag_refs":
