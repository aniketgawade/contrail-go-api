...
func (obj *ServiceTemplate) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= service_template_annotations
}
...
func (obj *ServiceTemplate) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & service_template_tag_refs == 0) {
...
func (obj *ServiceTemplate) AddTag(
        ...
        if obj.modified & service_template_tag_refs == 0 {
...
func (obj *ServiceTemplate) ClearTag() {
        if (obj.valid & service_template_tag_refs != 0) &&
           (obj.modified & service_template_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *ServiceTemplate) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & service_template_annotations != 0 {
                var value json.RawMessage
...
func (obj *ServiceTemplate) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= service_template_annotations
                        }
                        break
                case "display_name":
