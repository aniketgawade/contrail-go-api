...
func (obj *Project) SetVxlanRouting(value bool) {
        ...
        obj.modified |= project_vxlan_routing
}
...
func (obj *Project) readServiceGroups() error {
        if !obj.IsTransient() &&
                (obj.valid & project_service_groups == 0) {
...
func (obj *Project) readAddressGroups() error {
        if !obj.IsTransient() &&
                (obj.valid & project_address_groups == 0) {
...
func (obj *Project) readFirewallRules() error {
        if !obj.IsTransient() &&
                (obj.valid & project_firewall_rules == 0) {
...
func (obj *Project) readFirewallPolicys() error {
        if !obj.IsTransient() &&
                (obj.valid & project_firewall_policys == 0) {
...
func (obj *Project) readApplicationPolicySets() error {
        if !obj.IsTransient() &&
                (obj.valid & project_application_policy_sets == 0) {
...
func (obj *Project) AddTag(
        ...
        if obj.modified & project_tag_refs == 0 {
...
func (obj *Project) ClearTag() {
        if (obj.valid & project_tag_refs != 0) &&
           (obj.modified & project_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *Project) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & project_vxlan_routing != 0 {
                var value json.RawMessage
...
func (obj *Project) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "vxlan_routing":
                        ...
                        if err == nil {
                                obj.valid |= project_vxlan_routing
                        }
                        break
                case "alarm_enable":
