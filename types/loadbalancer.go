...
func (obj *Loadbalancer) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= loadbalancer_annotations
}
...
func (obj *Loadbalancer) readServiceApplianceSetRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_service_appliance_set_refs == 0) {
...
func (obj *Loadbalancer) AddServiceApplianceSet(
        ...
        if obj.modified & loadbalancer_service_appliance_set_refs == 0 {
...
func (obj *Loadbalancer) ClearServiceApplianceSet() {
        if (obj.valid & loadbalancer_service_appliance_set_refs != 0) &&
           (obj.modified & loadbalancer_service_appliance_set_refs == 0) {
                obj.storeReferenceBase("service-appliance-set", obj.service_appliance_set_refs)
        }
...
func (obj *Loadbalancer) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & loadbalancer_tag_refs == 0) {
...
func (obj *Loadbalancer) AddTag(
        ...
        if obj.modified & loadbalancer_tag_refs == 0 {
...
func (obj *Loadbalancer) ClearTag() {
        if (obj.valid & loadbalancer_tag_refs != 0) &&
           (obj.modified & loadbalancer_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *Loadbalancer) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & loadbalancer_annotations != 0 {
                var value json.RawMessage
...
func (obj *Loadbalancer) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= loadbalancer_annotations
                        }
                        break
                case "display_name":
