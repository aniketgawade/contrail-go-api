...
func (obj *BgpAsAService) SetAnnotations(value *KeyValuePairs) {
        ...
        obj.modified |= bgp_as_a_service_annotations
}
...
func (obj *BgpAsAService) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & bgp_as_a_service_tag_refs == 0) {
...
func (obj *BgpAsAService) AddTag(
        ...
        if obj.modified & bgp_as_a_service_tag_refs == 0 {
...
func (obj *BgpAsAService) ClearTag() {
        if (obj.valid & bgp_as_a_service_tag_refs != 0) &&
           (obj.modified & bgp_as_a_service_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *BgpAsAService) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & bgp_as_a_service_annotations != 0 {
                var value json.RawMessage
...
func (obj *BgpAsAService) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "annotations":
                        ...
                        if err == nil {
                                obj.valid |= bgp_as_a_service_annotations
                        }
                        break
                case "display_name":
