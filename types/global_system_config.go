...
const (
	...
	global_system_config_tag_value_range
...
func (obj *GlobalSystemConfig) SetBgpAlwaysCompareMed(value bool) {
        ...
        obj.modified |= global_system_config_bgp_always_compare_med
}
...
func (obj *GlobalSystemConfig) GetTagValueRange() int {
        return obj.tag_value_range
}

func (obj *GlobalSystemConfig) SetTagValueRange(value int) {
        obj.tag_value_range = value
        obj.modified |= global_system_config_tag_value_range
}
...
func (obj *GlobalSystemConfig) readTagRefs() error {
        if !obj.IsTransient() &&
                (obj.valid & global_system_config_tag_refs == 0) {
...
func (obj *GlobalSystemConfig) AddTag(
        ...
        if obj.modified & global_system_config_tag_refs == 0 {
...
func (obj *GlobalSystemConfig) ClearTag() {
        if (obj.valid & global_system_config_tag_refs != 0) &&
           (obj.modified & global_system_config_tag_refs == 0) {
                obj.storeReferenceBase("tag", obj.tag_refs)
        }
...
func (obj *GlobalSystemConfig) MarshalJSON() ([]byte, error) {
        ...
        if obj.modified & global_system_config_bgp_always_compare_med != 0 {
                var value json.RawMessage
        ...
        if obj.modified & global_system_config_tag_value_range != 0 {
                var value json.RawMessage
                value, err := json.Marshal(&obj.tag_value_range)
                if err != nil {
                        return nil, err
                }
                msg["tag_value_range"] = &value
        }
...
func (obj *GlobalSystemConfig) UnmarshalJSON(body []byte) error {
        ...
        for key, value := range m {
                ...
                case "bgp_always_compare_med":
                        ...
                        if err == nil {
                                obj.valid |= global_system_config_bgp_always_compare_med
                        }
                        break
                ...
                case "tag_value_range":
                        err = json.Unmarshal(value, &obj.tag_value_range)
                        if err == nil {
                                obj.valid |= global_system_config_tag_value_range
                        }
                        break
                case "id_perms":
